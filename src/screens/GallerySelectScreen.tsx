        ...
        <div className="flex-shrink-0 px-4 py-3 border-b border-dark-border">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2 bg-dark-card border border-dark-border text-white text-sm placeholder-gray-600 focus:outline-none focus:border-brand-primary/50 transition-colors"
            />
            {search && (
              <button
                onClick={() => setSearch('')}
